...
IL_009a:
	{
		...
		NullCheck(L_25);
		uint32_t L_27;
		L_27 = KeyValuePair_2_get_Value_mE485C93AB111C031ED3F75ACC4A6E67E0F0F4723_inline(((L_25)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_26))), il2cpp_rgctx_method(method->klass->rgctx_data, 20));
...
IL_009a:
	{
		...
		L_27 = KeyValuePair_2_get_Value_m9617D9D28DF3AA8EC0E34BB79A8C9EB95C6EAD04_inline(((L_25)->GetAddressAt(static_cast<il2cpp_array_size_t>(L_26))), il2cpp_rgctx_method(method->klass->rgctx_data, 20));
